...
\tablehead{
\colhead{$T_\textrm{eff}$ [K]} & \colhead{Age [Myr]} & \colhead{$\alpha_\textrm{E}$} & \colhead{$\sigma_{\alpha_\textrm{E}}$} & \colhead{$\beta_\textrm{E}$} & \colhead{$\sigma_{\beta_\textrm{E}}$} &  \colhead{$n_\textrm{E, fit}$} & \colhead{$N_\textrm{E}$} %& \colhead{$\alpha_\textrm{T}$} & \colhead{$\sigma_{\alpha_\textrm{T}}$} & \colhead{$A_*$} & \colhead{$\sigma_{A_*}$} &  \colhead{$n_\textrm{T, tot}$} & \colhead{$n_\textrm{T, fit}$} & \colhead{$N_\textrm{T}$}
}
\startdata
